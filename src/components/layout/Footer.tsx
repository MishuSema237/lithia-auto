            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="pt-8 border-t border-navy-800 flex flex-col lg:flex-row justify-between items-center gap-6 relative">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={scrollToTop} className="ml-4 w-8 h-8 md:w-12 md:h-12 rounded-full bg-gold-500 text-navy-900 flex items-center justify-center hover:bg-gold-400 transition-colors shadow-lg border-2 border-navy-900">
