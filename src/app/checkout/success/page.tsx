        ...
        <div className="bg-light-100 min-h-screen py-20 font-sans flex items-center justify-center">
            <div className="container mx-auto px-4 max-w-2xl">
                <div className="bg-white rounded-[40px] p-12 border border-light-300 shadow-2xl text-center relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-bold text-navy-900 mb-4 tracking-tight">Order Successful!</h1>
                    <p className="text-navy-600 text-lg mb-10 leading-relaxed font-medium">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                        <div className="bg-light-50 p-6 rounded-2xl border border-light-200 text-left">
                            ...
                            <p className="text-[12px] text-navy-600">Wait for your receipt and next steps in your inbox.</p>
                        </div>
                        <div className="bg-light-50 p-6 rounded-2xl border border-light-200 text-left">
                            ...
                            <p className="text-[12px] text-navy-600">Download your transaction details for your records.</p>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="/inventory" className="flex-1 bg-navy-900 text-gold-400 hover:bg-gold-500 hover:text-navy-900 py-4 px-8 rounded-2xl font-bold text-[15px] transition-all flex items-center justify-center group">
                            Continue Shopping <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link href="/" className="flex-1 bg-white border-2 border-navy-900 text-navy-900 hover:bg-navy-50 py-4 px-8 rounded-2xl font-bold text-[15px] transition-all flex items-center justify-center">
                            Return Home
                        </Link>
                    </div>
                </div>
