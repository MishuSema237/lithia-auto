                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <main className="w-full lg:w-[68%]">
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-[13px] text-navy-400 font-bold uppercase tracking-wider mb-8 pb-8 border-b border-light-100">
                            <div className="flex items-center gap-2"><User className="w-4 h-4 text-gold-500" /> {post.author || 'Lithia Auto'}</div>
                            ...
                            <div className="flex items-center gap-2"><MessageCircle className="w-4 h-4 text-gold-500" /> {post.commentsCount || 0} comment</div>
                        ...
                        <div className="prose prose-lg max-w-none prose-navy">
                            ...
                            <div className="text-navy-600 space-y-6 leading-loose text-[17px] whitespace-pre-line">
                                {post.content}
                            </div>
                            ...
                            {post.additionalContent && (
                                <div className="text-navy-600 space-y-6 leading-loose text-[17px] whitespace-pre-line mt-8">
                                    {post.additionalContent}
                                </div>
                            )}
                        </div>
