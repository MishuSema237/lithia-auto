            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="shadow-none border-light-300">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-navy-600 uppercase tracking-wider">Total Inventory</p>
                            <p className="text-3xl font-bold text-navy-900">124</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="shadow-none border-light-300">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-navy-600 uppercase tracking-wider">Testimonials</p>
                ...
                <Card className="shadow-none border-light-300">
                    <CardContent className="p-6 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-navy-600 uppercase tracking-wider">Blog Posts</p>
